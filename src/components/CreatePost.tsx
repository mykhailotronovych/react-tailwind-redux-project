...
import { addPost, cancelEdit, editingPost } from 'redux/blog.reducer';
...
export default function CreatePost() {
    ...
    useEffect(() => {
        if (editPost) {
            ...
            setValue('publishedAt', editPost.publishedAt);
            setValue('published', editPost.published);
        }
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [editPost]);

    const handleSubmitPost = (payload: Post) => {
        if (editPost) {
            dispatch(editingPost({ ...payload, id: editPost.id }));
            dispatch(cancelEdit());
        } else {
